...
const styles = StyleSheet.create({
  ...
  counter: { color: "#888" },
  card: { width: "100%", aspectRatio: 0.8, borderRadius: 20, backgroundColor: "#eee", overflow: "hidden" },
  thumbnail: { width: "100%", height: "70%" },
  overlay: { position: "absolute", top: 24, paddingVertical: 6, paddingHorizontal: 14, borderRadius: 8, borderWidth: 3 },
  keepOverlay: { left: 24, borderColor: "#2a8f4f", transform: [{ rotate: "-12deg" }] },
  deleteOverlay: { right: 24, borderColor: "#e05555", transform: [{ rotate: "12deg" }] },
  overlayText: { fontWeight: "800", fontSize: 20, letterSpacing: 1 },
  reasonBox: { padding: 12, gap: 4 },
  sizeText: { fontWeight: "700", fontSize: 16 },
